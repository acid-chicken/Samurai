...
<div align="center">
  ...
  <p>BitZeny ユーザーのための Discord Bot</p>
</div>

## 使い方

1. [.NET Core SDK](https://dot.net/core) を入手します。
2. *config.json* を次のように作成します。

```json
{
  "discord_token": "トークンをここに入力"
}
```

1. `dotnet restore` と `dotnet run --project Samurai` を実行します。
2. さあはじめよう！

## 必要なもの

- [.NET Core SDK 2.0.0 以降](https://dot.net/core)
